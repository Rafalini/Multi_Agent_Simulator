...
#include <memory>
#include "../client/headers/point.h"
...
QT_MOC_LITERAL(1, 6, 10), // "addSegment"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 28), // "std::shared_ptr<LineSegment>"
QT_MOC_LITERAL(4, 47, 3) // "seg"

    },
    "Point\0addSegment\0\0std::shared_ptr<LineSegment>\0"
    "seg"
};
...
void Point::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addSegment((*reinterpret_cast< std::shared_ptr<LineSegment>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
